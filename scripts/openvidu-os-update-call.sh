...
# Deploying
curl -L -o /tmp/openvidu-call.tar.gz https://github.com/OpenVidu/openvidu-call/releases/download/v${OPENVIDU_PRO_VERSION}/openvidu-call-${OPENVIDU_PRO_VERSION}.tar.gz
