...
aws s3 cp s3://aws.openvidu.io/install_openvidu_"${FROM_VERSION}".yaml s3://aws.openvidu.io/install_openvidu_"${TO_VERSION}".yaml --acl public-read
aws s3 cp s3://aws.openvidu.io/install_openvidu_pro_"${FROM_VERSION}".yaml s3://aws.openvidu.io/install_openvidu_pro_"${TO_VERSION}".yaml --acl public-read
aws s3 cp s3://aws.openvidu.io/install_media_node_"${FROM_VERSION}".yaml s3://aws.openvidu.io/install_media_node_"${TO_VERSION}".yaml --acl public-read